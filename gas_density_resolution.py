...
titlelist = ['a) Threshold-based model'+'\n'+'Low Resolution', 'b) Threshold-based model' + '\n' + 'Medium Resolution','c) Padoan et al. (2012)'+'\n'+ 'Low Resolution', 'd) Padoan et al. (2012)'+'\n'+'Medium Resolution', '', '', '', '']
...
plt.savefig('density_iso_res_com_both.pdf', bbox_inches='tight')
plt.clf()
