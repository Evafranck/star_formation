...
#####################################################################################################
pathlist = ['../low_master_iso', '../low_padoan_iso', '../low_federrath_tempcut_iso', '../low_federrath_new_iso']
simulation = ['Threshold-based model', 'Padoan et al. (2012)', r'c) Federrath & Klessen (2012)' + '\n' + 'with temperature cut', r'd) Federrath & Klessen (2012)' + '\n' + 'without temperature cut']
######################################################################################################
...
label = ['Threshold-based model', 'Padoan et al. (2012)', r'Federrath & Klessen (2012)' + '\n' + 'with temperature cut', r'Federrath & Klessen (2012)' + '\n' + 'without temperature cut']
...
for n in range(1):
    ...
    ax.text(1,2.3,r'Scale length of the disk $R_d$',fontsize=12,color='black',horizontalalignment='center',verticalalignment='center')
    ax.text(1,0.5,r'Scale length of the bulge $R_{\rm eff}$',fontsize=12,color='black',horizontalalignment='center',verticalalignment='center')
    ...
    for k, sim in enumerate(pathlist):
        ...
        ax.legend(fontsize=16, loc='center', bbox_to_anchor=(0.6, 0.85))
...
plt.savefig('scale_length_time_low.pdf', bbox_inches='tight')
