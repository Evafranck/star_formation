...
model = ['master', 'padoan', 'semenov', 'evans', 'federrath_tempcut', 'federrath_new']
labellist = ['Threshold-based model', 'Padoan et al. (2012)', 'Semenov et al. (2016)', 'Evans et al. (2022)', 'Federrath & Klessen (2012)' + '\n' + 'with temperature cut', 'Federrath & Klessen (2012)' + '\n' + 'without temperature cut']
colorlist = ['blue','orange', 'green', 'red', 'purple', 'black']
