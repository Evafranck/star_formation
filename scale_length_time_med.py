...
for n in range(1):
    ...
    ax.text(1,2.6,r'Scale length of the disk $R_d$',fontsize=12,color='black',horizontalalignment='center',verticalalignment='center')
    ...
    for k, sim in enumerate(pathlist):
        ...
        ax.legend(fontsize=16, loc='center', bbox_to_anchor=(0.6, 0.8))
...
plt.savefig('scale_length_time_med.pdf', bbox_inches='tight')
