...
#####################################################################################################
titlelist = ['Scale length over time for stars'+'\n' + 'with age < 100 Myr (Low Resolution)', 'Scale length over time for stars'+'\n' + 'with age < 100 Myr (Medium Resolution)']
...
simulation = ['Threshold-based model', 'Padoan et al. (2012)','Semenov et al. (2016)', 'Evans et al. (2022)']
...
label = ['Threshold-based model', 'Padoan et al. (2012)', 'Semenov et al. (2016)', 'Evans et al. (2022)']
label2 = ['bulge threshold-based model', 'bulge Padoan (2012)', 'bulge Semenov et al. (2016)', 'bulge Evans et al. (2022)']
...
for n in range(2):
    ...
    ax.text(0.9,loc2[n],r'Scale length of the disk $R_d$',fontsize=12,color='black',horizontalalignment='center',verticalalignment='center')
    ...
    ax.set_title(titlelist[n], fontsize = 14)
    ...
    for k, sim in enumerate(pathlist[n]):
        ...
        for name in simname:
            ...
            eps = 0.3 #h1['eps'].min() #this gives 50 bins
            nbins = int(rgal/eps)
...
plt.savefig('scale_length_time_both_100.pdf', bbox_inches='tight')
