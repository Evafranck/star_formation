...
sim_labels = [r'Threshold-based model', r'Semenov et al. (2016)', r'Evans et al. (2022)', r'Federrath et al. (2014)']
...
def KS(mod):
    ...
    #s = s_all[disk]
    s = s_all
    KS_gas_dens.append(schmidtlaw(s, pretime = '50 Myr', compare = True, bins = 20)[0])
    KS_star_dens.append(schmidtlaw(s, pretime = '50 Myr', compare = True, bins = 20)[1])
    KS_xsigma.append(schmidtlaw(s, pretime = '50 Myr', compare = True, bins = 20)[2])
    KS_ysigma.append(schmidtlaw(s, pretime = '50 Myr', compare = True, bins = 20)[3])
